...
import com.leo.mall.search.feign.ProductFeignService;
import com.leo.mall.search.service.MallSearchService;
import com.leo.mall.search.vo.AttrResponseVo;
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        if (!CollectionUtils.isEmpty(param.getAttrs())) {
            ...
            for (String attrStr : param.getAttrs()) {
                ...
                NestedQueryBuilder nestedQuery = QueryBuilders.nestedQuery("attr", nestedBoolQuery, ScoreMode.None);
        ...
        //分类聚合的子聚合
        catalog_agg.subAggregation(AggregationBuilders.terms("catalog_name_agg").field("catalog_name").size(1));
        ...
        attr_id_agg.subAggregation(AggregationBuilders.terms("attr_value_agg").field("att_value").size(50));
